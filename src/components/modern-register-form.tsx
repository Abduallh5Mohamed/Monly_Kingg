...
export default function ModernRegisterForm() {
  ...
  return (
    <div className="fixed inset-0 overflow-hidden">
      ...
      <div className="relative z-10 h-full flex items-start md:items-center justify-center md:justify-end px-4 md:pr-12 lg:pr-20 pt-20 md:pt-16 pb-8 overflow-y-auto">
        <Card className="w-full max-w-md shadow-xl border-0 bg-transparent backdrop-blur-md">
        <CardHeader className="space-y-1 text-center pb-6 pt-5">
